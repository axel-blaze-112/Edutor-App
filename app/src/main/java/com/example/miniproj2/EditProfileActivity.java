...
public class EditProfileActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        firedb.child("users").child(currentuserid).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {


                if((dataSnapshot.exists()&&(dataSnapshot.hasChild("username")) && (dataSnapshot.hasChild("useremail")) )){
                    String dbcurrentusername= dataSnapshot.child("username").getValue().toString();
                    String dbcurrentuseremail= dataSnapshot.child("useremail").getValue().toString();
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
                    {
                        taskSnapshot.getStorage().getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                        {
                            ...
                            public void onSuccess(Uri uri)
                            {
                                ...
                                firedb.child("users").child(currentuserid).updateChildren(profileuri)
                                        .addOnCompleteListener(new OnCompleteListener<Void>()
                                        {
                                            ...
                                            {
                                                LoadingBar.dismiss();
                                                Toast.makeText(EditProfileActivity.this, "Profile Image Updated Successfully", Toast.LENGTH_LONG).show();
                                            }
                                        });
                            }
                        });
    ...
    private void UpdateSettings(){
       ...
       // String Age=
        ...
        if(TextUtils.isEmpty(dobs)){
            ...
            firedb.child("users").child(currentuserid).updateChildren(profile).addOnCompleteListener(new OnCompleteListener<Void>() {
                @Override
                public void onComplete(@NonNull Task<Void> task) {
