...
import com.example.miniproj2.Spin.WheelUtils;
...
public class pieView extends View {
    ...
    private int center,padding ,targetIndex,roundOfNumber=1;
    ...
    private void drawImage(Canvas canvas, float tempAngle, Bitmap bitmap)
    {
        ...
        float angle=(float)((tempAngle+360/spinItemList.size()/2)*Math.PI/180);
